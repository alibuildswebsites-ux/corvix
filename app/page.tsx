...
export default function Home() {
  return (
    ...
    <div className="relative">
      ...
      <section id="cta" className="border-t border-[rgba(255,255,255,0.08)]"><div className="w-full max-w-[1400px] mx-auto px-5 sm:px-8 md:px-12 lg:px-20 py-20 md:py-32 text-center"><h2 data-reveal className="font-display font-extrabold text-[clamp(2.5rem,6vw,5rem)] leading-tight text-corvix-text mb-6">Ready to build<br />something real?</h2><p data-reveal data-reveal-delay="0.08" className="text-corvix-muted text-xl mb-10 max-w-md mx-auto">Tell us what you&apos;re working on. We&apos;ll take it from idea to production.</p><div data-reveal data-reveal-delay="0.14"><Link href="/contact" className="inline-flex items-center gap-2 bg-corvix-accent hover:bg-corvix-accent-hover text-black font-semibold px-10 py-4 rounded-xl transition-colors duration-200">Start a Project</Link></div></div></section>
    </div>
    </ScrollRevealRoot>
  );
}
