  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <button
        ...
        className="w-full inline-flex items-center justify-center gap-2 bg-corvix-accent hover:bg-corvix-accent-hover disabled:opacity-60 text-black font-semibold py-4 rounded-xl transition-colors duration-200 cursor-pointer animate__animated animate__pulse animate__infinite animate__slower"
      >
